...
const btnAgregarEstudiante = document.querySelector("#idBtnAgregarEstudiante");
const btnMostrarEstudiantes = document.querySelector("#idBtnMostrarEstudiantes");

//Agregamos el evento click a los botones, adicionalmente
//se le asigna la funcion que realizara la operacion
btnAgregarEstudiante.addEventListener("click", addEstudiantes);
btnMostrarEstudiantes.addEventListener("click", viewEstudiantes);
